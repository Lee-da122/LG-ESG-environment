const ITEMS = [
  {
    ...
    conditions: [
      { label: '살대·천·손잡이 파손', route: 'pro',
        conditions: [
          '살대가 휘었어요', '우산살이 휘었어요', '살이 구부러졌어요', '프레임이 휘었어요',
          '천이 찢어졌어요', '우산 천에 구멍났어요', '원단이 뜯어졌어요', '천이 터졌어요',
          '손잡이가 빠졌어요', '손잡이가 망가졌어요', '손잡이가 부러졌어요', '손잡이가 헐거워요', '손잡이가 흔들려요', '손잡이 고장났어요',
          '살대가 부러졌어요', '우산살이 부러졌어요', '살대는 망가졌는데 천은 멀쩡해요', '뼈대가 부서졌어요',
        ] },
